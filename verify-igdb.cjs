...
(async()=>{
  ...
  await page.evaluate(()=>localStorage.setItem(metadataKey('/games/cached/'),JSON.stringify({year:2020,developers:['Remedy Entertainment'],developerLogos:{'Remedy Entertainment':'https://images.igdb.com/igdb/image/upload/t_logo_med/cl7m5.png'},genres:['Adventure'],plays:100,checked:true,savedAt:1})));
  await page.reload();
  let requested=[];
