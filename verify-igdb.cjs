...
(async()=>{
  ...
  await page.evaluate(()=>localStorage.setItem(metadataKey('/games/cached/'),JSON.stringify({year:2020,gameType:'Main Game',developers:['Remedy Entertainment'],developerLogos:{'Remedy Entertainment':'https://images.igdb.com/igdb/image/upload/t_logo_med/cl7m5.png'},genres:['Adventure'],publishers:[],publisherLogos:{},gameModes:[],playerPerspectives:['Third person'],themes:['Action'],franchises:['Alan Wake'],gameEngines:['Northlight'],plays:100,checked:true,savedAt:1})));
  await page.reload();
  let requested=[];
